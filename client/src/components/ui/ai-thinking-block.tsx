...
export default function AIThinkingBlock() {
  ...
  const ThinkingContent = `Analyzing job market trends for UX Design...
Checking LinkedIn for recent postings in San Francisco and Remote...
Filtering for Entry-level and Mid-level positions...
Identifying top-tier startups with Series B+ funding...
Scanning Indeed for unique opportunities...
Matching roles with user preferences: Product Design, FinTech, Remote-friendly...
Verifying salary ranges and benefits...
Synthesizing results for Senior UX Designer roles...
Cross-referencing company culture and growth potential...
Finalizing job recommendations...`;
