  ...
  return (
    ...
    >
      <div className="flex items-center space-x-4">
        ...
        >
          <svg width="18" height="18" viewBox="0 0 367 367" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ display: 'block' }}>
            <path d="M107.959 47.1249C127.841 46.855 148.418 47.1067 168.365 47.1063L260.437 47.1493L260.438 77.5243L290.869 77.5028L290.856 108.077L321.401 108.093L321.382 260.455L290.933 260.416C290.685 270.412 290.86 280.93 290.837 290.985L260.477 290.998L260.441 320.984C259.688 321.666 249.517 321.393 247.622 321.393H218.404L107.995 321.37C107.779 311.463 107.958 300.942 107.959 290.985L77.5527 290.975C77.3932 280.93 77.5361 270.511 77.4844 260.429L47.0352 260.445L47 108.083C57.0985 107.956 67.3851 108.069 77.4971 108.084L77.5625 77.5028L107.955 77.5165L107.959 47.1249ZM108.119 77.7606L108.086 108.173L77.7373 108.163L77.7129 260.343H108.096L108.074 290.758L260.331 290.767C260.333 280.669 260.235 270.398 260.345 260.316L290.688 260.319L290.718 108.184C280.693 108.176 270.346 108.306 260.353 108.142L260.321 77.7079L108.119 77.7606Z" fill="#E1E9F0"/>
            <path d="M107.988 199.422L138.609 199.461C138.859 209.313 138.631 220.067 138.619 229.988L229.736 229.975L229.795 199.445H260.429C260.59 209.491 260.437 219.912 260.426 229.988C257.628 230.229 252.799 230.087 249.877 230.084L229.962 230.067L229.953 260.459L138.462 260.439L138.459 230.054L107.98 230.064C107.78 220.196 107.889 209.319 107.988 199.422Z" fill="#E1E9F0"/>
            <path d="M138.457 138.469L168.996 138.447L168.998 169.073L138.463 169.07L138.457 138.469Z" fill="#E1E9F0"/>
            <path d="M199.454 138.449L230 138.467C229.937 148.673 229.926 158.88 229.966 169.086L199.436 169.059L199.454 138.449Z" fill="#E1E9F0"/>
          </svg>
        </div>
