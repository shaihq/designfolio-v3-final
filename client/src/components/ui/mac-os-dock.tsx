        ...
        {apps.map((app) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 bg-white m-4 rounded-md border border-[#e0ddd8] shadow-sm overflow-y-auto relative custom-scrollbar">
                <div className="w-full flex flex-col relative font-azeretMono p-8">
